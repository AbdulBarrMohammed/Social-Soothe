...
export async function submitAnswers(email, questionOne, questionTwo, questionThree, questionFour, questionFive, questionSix, questionSeven, setShowSubmit) {
    ...
    const response = await fetch(`https://social-soothe.onrender.com/api/flowers/create`, {
        method: 'POST',
...
export async function handleColorChange(done, currId, setOpenFlowerModal) {
        try {
            ...
            const response = await fetch(`https://social-soothe.onrender.com/api/flowers/flower/color/update/${currId}`, {
            method: 'POST',
            headers: { 'Content-Type': 'application/json' },
...
export async function deleteFlower(currId) {
    if (confirm("Are you sure you want to delete?")) {
        try {
            const res = await fetch(`https://social-soothe.onrender.com/api/flowers/flower/delete/${currId}`)
...
export async function addQuestionSeven(currId, questionSeven, setQuestionSevenModal) {
    try {
        const id = currId
        const response = await fetch(`https://social-soothe.onrender.com/api/flowers/flower/questionSeven/update/${currId}`, {
        method: 'POST',
        headers: { 'Content-Type': 'application/json' },
