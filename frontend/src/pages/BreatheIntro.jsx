            ...
            {authToken &&
                <div className="flex flex-col items-center pt-10 gap-10 h-screen" style={{ backgroundColor: lightestBg }}>
                    ...
                    <div className="flex gap-10 text-emojiSadWord">
                        <Link to={"/breathe/3/3/3"} className="bg-emojiSad flex flex-col items-center justify-center p-4 h-56 w-56 text-center rounded-3xl cursor-pointer">

                            <p className="font-bold text-lg">3-3-3 breathing exercise:</p>
                            <p className="font-bold text-lg">For stress</p>
                        </Link>
                        <Link to={"/breathe/4/2/6"} className="bg-emojiSad flex flex-col items-center justify-center p-4 h-56 w-56 text-center rounded-3xl cursor-pointer">
                            <p className="font-bold text-lg">4-2-6 breathing exercise:</p>
                            <p className="font-bold text-lg">To steady nerves</p>
                        </Link>
                        <Link to={"/breathe/4/7/8"} className="bg-emojiSad flex flex-col items-center justify-center p-4 h-56 w-56 text-center rounded-3xl cursor-pointer">
