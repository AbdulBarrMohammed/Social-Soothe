...
export function EditFlower() {
    ...
    useEffect(() => {
        ...
        async function loadFlower() {
            try {
                const res = await fetch(`https://social-soothe.onrender.com/api/flowers/flower/${id}`)
    ...
    async function handleSubmit(e) {
        e.preventDefault();
        try {
            const response = await fetch(`https://social-soothe.onrender.com/api/flowers/flower/update/${id}`, {
            method: 'POST',
